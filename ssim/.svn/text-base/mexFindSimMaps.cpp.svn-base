...
void usagerr(const char *msg) {
  mexPrintf("%s",msg);
  mexErrMsgTxt("Usage: simMaps=mexFindSimMaps(xIndices,yIndices,imgpatches,simMapParams,nChannels);\n");
}
...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[]) {
  ...
  int numRadiiIntervals,numThetaIntervals,numDescriptors;
  ...
  //////////////////////////////////////////////////////////////////////////
  // Major break: decide how many channels.
  //////////////////////////////////////////////////////////////////////////
  if(nChannels==3){
    ...
    // Loop through the number of descriptors to compute.
    // This will typically be large.
