%FAST8. perform an  FAST corner detection from your FAST-ER generated tree
%    [corners, scores] = FAST8.(image, threshold) performs the detection on the image
...
%
%    [corners, scores] = FAST8.(image, threshold, nonmax) performs the corner
...
%     }
function [ corners scores ] = fast8(image, threshold, do_nonmax)
