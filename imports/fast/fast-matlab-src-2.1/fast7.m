%FAST7. perform an  FAST corner detection from your FAST-ER generated tree
%    [corners, scores] = FAST7.(image, threshold) performs the detection on the image
...
%
%    [corners, scores] = FAST7.(image, threshold, nonmax) performs the corner
...
%     }
function [ corners scores ] = fast7(image, threshold, do_nonmax)
